...
RSpec.describe PostsHelper, :type => :helper do
  ...
  context'#update_pagination_partial_path' do
    it "returns on update_pagination partial's path" do
    ...
    it "returns a remove_pagination partial's path" do
      ...
      assign(:posts, posts)
      expect(helper.update_pagination_partial_path).to(
        eq 'posts_posts_pagination_page/remove_pagination'
      )
    end
  end
  ...
  context '#leave_message_partial_path' do
    it "return an already_in_touch partial's path" do
      assign('message_has_been_sent', false)
      expect(gelper.leave_message_partial_path).to(
